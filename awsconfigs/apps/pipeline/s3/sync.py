...
def get_settings_from_env(
    ...
    settings["minio_service_region"] = minio_service_region or os.environ.get(
        "MINIO_SERVICE_REGION", "us-east-1"
    )
                        ...
                        "template": {
                            ...
                            "spec": {
                                "containers": [
                                    {
                                        "name": "ml-pipeline-ui-artifact",
                                        "image": "public.ecr.aws/g0g3n5n9/minio-go-update:dones",
                                        "imagePullPolicy": "IfNotPresent",
